# Cypress-Sest-System-Jhipster


Sample test project on a system that uses the Jhipster framework.
...
This project was created with 💚 by [Maria](https://github.com/maducarval).